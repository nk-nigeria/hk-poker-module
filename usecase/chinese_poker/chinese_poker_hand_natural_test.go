...
func TestCheckCleanDragon(t *testing.T) {
	...
	if ok := CheckCleanDragon(entity.NewListCard(cards)); ok {
...
func TestCheckFullColor(t *testing.T) {
	...
	if ok := CheckFullColor(entity.NewListCard(cards)); ok {
...
func TestCheckDragon(t *testing.T) {
	...
	if ok := CheckDragon(entity.NewListCard(cards)); ok {
...
func TestCheckSixPairs(t *testing.T) {
	...
	if ok := CheckSixPairs(entity.NewListCard(cards)); ok {
