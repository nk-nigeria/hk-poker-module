...
const (
	...
	OpCodeUpdate_OPCODE_UPDATE_ORGANIZE_ACK OpCodeUpdate = 3 //TODO: remove
	OpCodeUpdate_OPCODE_UPDATE_FINISH       OpCodeUpdate = 4 //message UpdateFinish
	// Request was rejected.
	OpCodeUpdate_OPCODE_UPDATE_REJECTED OpCodeUpdate = 5
	// Update game state
	OpCodeUpdate_OPCODE_UPDATE_GAME_STATE OpCodeUpdate = 6
	// update card state/combibne, show, delare
	OpCodeUpdate_OPCODE_UPDATE_CARD_STATE OpCodeUpdate = 7
)
...
var (
	OpCodeUpdate_name = map[int32]string{
		...
		3: "OPCODE_UPDATE_ORGANIZE_ACK",
		4: "OPCODE_UPDATE_FINISH",
		5: "OPCODE_UPDATE_REJECTED",
		6: "OPCODE_UPDATE_GAME_STATE",
		7: "OPCODE_UPDATE_CARD_STATE",
	}
	OpCodeUpdate_value = map[string]int32{
		"OPCODE_UPDATE_UNSPECIFIED":  0,
		"OPCODE_UPDATE_PRESENCE":     1,
		"OPCODE_UPDATE_DEAL":         2,
		"OPCODE_UPDATE_ORGANIZE_ACK": 3,
		"OPCODE_UPDATE_FINISH":       4,
...
const (
	...
	WinType_WIN_TYPE_LOSE_THREE_LIMBS          WinType = 1
	WinType_WIN_TYPE_LOSE_ALL_PLAYER           WinType = 2
	WinType_WIN_TYPE_WIN_FRONT_THREE_OF_A_KIND WinType = 3
	WinType_WIN_TYPE_WIN_MID_FULL_HOUSE        WinType = 4
	WinType_WIN_TYPE_WIN_BACK_FOUR_OF_A_KIND   WinType = 5
	WinType_WIN_TYPE_WIN_MID_FOUR_OF_A_KIND    WinType = 6
	WinType_WIN_TYPE_WIN_BACK_STRAIGHT_FLUSH   WinType = 7
	WinType_WIN_TYPE_WIN_MID_STRAIGHT_FLUSH    WinType = 8
	//
	WinType_WIN_TYPE_WIN_CLEAN_DRAGON              WinType = 9
	WinType_WIN_TYPE_WIN_DRAGON                    WinType = 10
	WinType_WIN_TYPE_WIN_FIVE_PAIR_THREE_OF_A_KIND WinType = 11
	WinType_WIN_TYPE_WIN_SIX_AND_A_HALF_PAIRS      WinType = 12
	WinType_WIN_TYPE_WIN_THREE_STRAIGHT_FLUSH      WinType = 13
	WinType_WIN_TYPE_WIN_THREE_STRAIGHT            WinType = 14
	WinType_WIN_TYPE_WIN_THREE_FLUSH               WinType = 15
)
...
var (
	WinType_name = map[int32]string{
		...
		1:  "WIN_TYPE_LOSE_THREE_LIMBS",
		2:  "WIN_TYPE_LOSE_ALL_PLAYER",
		3:  "WIN_TYPE_WIN_FRONT_THREE_OF_A_KIND",
		4:  "WIN_TYPE_WIN_MID_FULL_HOUSE",
		5:  "WIN_TYPE_WIN_BACK_FOUR_OF_A_KIND",
		6:  "WIN_TYPE_WIN_MID_FOUR_OF_A_KIND",
		7:  "WIN_TYPE_WIN_BACK_STRAIGHT_FLUSH",
		8:  "WIN_TYPE_WIN_MID_STRAIGHT_FLUSH",
		9:  "WIN_TYPE_WIN_CLEAN_DRAGON",
		10: "WIN_TYPE_WIN_DRAGON",
		11: "WIN_TYPE_WIN_FIVE_PAIR_THREE_OF_A_KIND",
		12: "WIN_TYPE_WIN_SIX_AND_A_HALF_PAIRS",
		13: "WIN_TYPE_WIN_THREE_STRAIGHT_FLUSH",
		14: "WIN_TYPE_WIN_THREE_STRAIGHT",
		15: "WIN_TYPE_WIN_THREE_FLUSH",
	}
	WinType_value = map[string]int32{
		"WIN_TYPE_UNSPECIFIED":                   0,
		"WIN_TYPE_LOSE_THREE_LIMBS":              1,
		"WIN_TYPE_LOSE_ALL_PLAYER":               2,
		"WIN_TYPE_WIN_FRONT_THREE_OF_A_KIND":     3,
		"WIN_TYPE_WIN_MID_FULL_HOUSE":            4,
		"WIN_TYPE_WIN_BACK_FOUR_OF_A_KIND":       5,
		"WIN_TYPE_WIN_MID_FOUR_OF_A_KIND":        6,
		"WIN_TYPE_WIN_BACK_STRAIGHT_FLUSH":       7,
		"WIN_TYPE_WIN_MID_STRAIGHT_FLUSH":        8,
		"WIN_TYPE_WIN_CLEAN_DRAGON":              9,
		"WIN_TYPE_WIN_DRAGON":                    10,
		"WIN_TYPE_WIN_FIVE_PAIR_THREE_OF_A_KIND": 11,
		"WIN_TYPE_WIN_SIX_AND_A_HALF_PAIRS":      12,
		"WIN_TYPE_WIN_THREE_STRAIGHT_FLUSH":      13,
		"WIN_TYPE_WIN_THREE_STRAIGHT":            14,
		"WIN_TYPE_WIN_THREE_FLUSH":               15,
	}
)
...
type PairResult struct {
	...
	Presence1 string `protobuf:"bytes,1,opt,name=presence1,proto3" json:"presence1,omitempty"`
	Presence2 string `protobuf:"bytes,2,opt,name=presence2,proto3" json:"presence2,omitempty"`
	...
	Third     int32  `protobuf:"varint,5,opt,name=third,proto3" json:"third,omitempty"`
	Special1  int32  `protobuf:"varint,6,opt,name=special1,proto3" json:"special1,omitempty"`
	Special2  int32  `protobuf:"varint,7,opt,name=special2,proto3" json:"special2,omitempty"`
}

func (x *PairResult) Reset() {
	*x = PairResult{}
	if protoimpl.UnsafeEnabled {
...
func (x *PairResult) ProtoReflect() protoreflect.Message {
	mi := &file_proto_chinese_poker_game_api_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PairResult.ProtoReflect.Descriptor instead.
func (*PairResult) Descriptor() ([]byte, []int) {
	return file_proto_chinese_poker_game_api_proto_rawDescGZIP(), []int{7}
}

func (x *PairResult) GetPresence1() string {
	if x != nil {
		return x.Presence1
	}
	return ""
...
func (x *PairResult) GetPresence2() string {
	if x != nil {
		return x.Presence2
	}
	return ""
...
func (x *PairResult) GetFirst() int32 {
	if x != nil {
		return x.First
	}
	return 0
...
func (x *PairResult) GetSecond() int32 {
	if x != nil {
		return x.Second
	}
	return 0
...
func (x *PairResult) GetThird() int32 {
	if x != nil {
		return x.Third
	}
	return 0
...
func (x *PairResult) GetSpecial1() int32 {
	if x != nil {
		return x.Special1
	}
	return 0
...
func (x *PairResult) GetSpecial2() int32 {
	if x != nil {
		return x.Special2
	}
	return 0
...
type UpdateResult struct {
	...
	PresenceOrganizes map[string]*PresenceCards `protobuf:"bytes,1,rep,name=presence_organizes,json=presenceOrganizes,proto3" json:"presence_organizes,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Results           []*PairResult             `protobuf:"bytes,2,rep,name=results,proto3" json:"results,omitempty"`
}
...
func (x *UpdateResult) GetPresenceOrganizes() map[string]*PresenceCards {
	if x != nil {
		return x.PresenceOrganizes
	}
	return nil
}

func (x *UpdateResult) GetResults() []*PairResult {
	if x != nil {
		return x.Results
	}
	return nil
...
type ComparisonResult struct {
	...
	UserCompetitor string `protobuf:"bytes,2,opt,name=user_competitor,json=userCompetitor,proto3" json:"user_competitor,omitempty"`
	FrontFactor    int64  `protobuf:"varint,3,opt,name=front_factor,json=frontFactor,proto3" json:"front_factor,omitempty"`
	MiddleFactor   int64  `protobuf:"varint,4,opt,name=middle_factor,json=middleFactor,proto3" json:"middle_factor,omitempty"`
	BackFactor     int64  `protobuf:"varint,5,opt,name=back_factor,json=backFactor,proto3" json:"back_factor,omitempty"`
	FrontBonus     int64  `protobuf:"varint,6,opt,name=front_bonus,json=frontBonus,proto3" json:"front_bonus,omitempty"`
	MiddleBonus    int64  `protobuf:"varint,7,opt,name=middle_bonus,json=middleBonus,proto3" json:"middle_bonus,omitempty"`
	BackBonus      int64  `protobuf:"varint,8,opt,name=back_bonus,json=backBonus,proto3" json:"back_bonus,omitempty"`
	CleanWinBonus  int64  `protobuf:"varint,10,opt,name=clean_win_bonus,json=cleanWinBonus,proto3" json:"clean_win_bonus,omitempty"`
	WinType        int64  `protobuf:"varint,11,opt,name=win_type,json=winType,proto3" json:"win_type,omitempty"`
}
...
func (x *ComparisonResult) GetUserCompetitor() string {
	if x != nil {
		return x.UserCompetitor
	}
	return ""
}
...
func (x *ComparisonResult) GetFrontBonus() int64 {
	if x != nil {
		return x.FrontBonus
	}
	return 0
...
func (x *ComparisonResult) GetMiddleBonus() int64 {
	if x != nil {
		return x.MiddleBonus
	}
	return 0
}

func (x *ComparisonResult) GetBackBonus() int64 {
	if x != nil {
		return x.BackBonus
	}
	return 0
...
func (x *ComparisonResult) GetCleanWinBonus() int64 {
	if x != nil {
		return x.CleanWinBonus
	}
	return 0
}

func (x *ComparisonResult) GetWinType() int64 {
	if x != nil {
		return x.WinType
	}
	return 0
...
var file_proto_chinese_poker_game_api_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x65, 0x6e, 0x63, 0x65, 0x43, 0x61, 0x72, 0x64, 0x22, 0xc4, 0x01, 0x0a, 0x0a, 0x50,
	0x61, 0x69, 0x72, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x70, 0x72, 0x65,
	0x73, 0x65, 0x6e, 0x63, 0x65, 0x31, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x72,
	0x65, 0x73, 0x65, 0x6e, 0x63, 0x65, 0x31, 0x12, 0x1c, 0x0a, 0x09, 0x70, 0x72, 0x65, 0x73, 0x65,
	0x6e, 0x63, 0x65, 0x32, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x72, 0x65, 0x73,
	0x65, 0x6e, 0x63, 0x65, 0x32, 0x12, 0x14, 0x0a, 0x05, 0x66, 0x69, 0x72, 0x73, 0x74, 0x18, 0x03,
	...
	,
	...
	,
	...
	0x0a, 0x53, 0x55, 0x49, 0x54, 0x5f, 0x43, 0x4c, 0x55, 0x42, 0x53, 0x10, 0x01, 0x12, 0x11, 0x0a,
	0x0d, 0x53, 0x55, 0x49, 0x54, 0x5f, 0x44, 0x49, 0x41, 0x4d, 0x4f, 0x4e, 0x44, 0x53, 0x10, 0x02,
	...
	0x4f, 0x49, 0x43, 0x45, 0x5f, 0x48, 0x49, 0x54, 0x10, 0x02, 0x2a, 0xc6, 0x01, 0x0a, 0x0d, 0x4f,
	...
	,
	...
	,
...
var file_proto_chinese_poker_game_api_proto_enumTypes = make([]protoimpl.EnumInfo, 10)
var file_proto_chinese_poker_game_api_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_proto_chinese_poker_game_api_proto_goTypes = []interface{}{
	...
	(WinType)(0),             // 9: api.WinType
	(*Card)(nil),             // 10: api.Card
	(*ListCard)(nil),         // 11: api.ListCard
	(*NewGame)(nil),          // 12: api.NewGame
	(*Organize)(nil),         // 13: api.Organize
	(*UpdatePresence)(nil),   // 14: api.UpdatePresence
	(*PresenceCards)(nil),    // 15: api.PresenceCards
	(*UpdateDeal)(nil),       // 16: api.UpdateDeal
	(*PairResult)(nil),       // 17: api.PairResult
	(*UpdateResult)(nil),     // 18: api.UpdateResult
	(*UpdateGameState)(nil),  // 19: api.UpdateGameState
	(*ArrangeCard)(nil),      // 20: api.ArrangeCard
	(*UpdateFinish)(nil),     // 21: api.UpdateFinish
	(*ComparisonResult)(nil), // 22: api.ComparisonResult
	nil,                      // 23: api.UpdateResult.PresenceOrganizesEntry
}
var file_proto_chinese_poker_game_api_proto_depIdxs = []int32{
	...
	10, // 3: api.ListCard.cards:type_name -> api.Card
	11, // 4: api.Organize.cards:type_name -> api.ListCard
	10, // 5: api.PresenceCards.cards:type_name -> api.Card
	15, // 6: api.UpdateDeal.presence_card:type_name -> api.PresenceCards
	23, // 7: api.UpdateResult.presence_organizes:type_name -> api.UpdateResult.PresenceOrganizesEntry
	17, // 8: api.UpdateResult.results:type_name -> api.PairResult
	6,  // 9: api.UpdateGameState.state:type_name -> api.GameState
	20, // 10: api.UpdateGameState.arrange_card:type_name -> api.ArrangeCard
	15, // 11: api.UpdateGameState.presenceCards:type_name -> api.PresenceCards
	8,  // 12: api.ArrangeCard.card_event:type_name -> api.CardEvent
	22, // 13: api.UpdateFinish.results:type_name -> api.ComparisonResult
	15, // 14: api.UpdateResult.PresenceOrganizesEntry.value:type_name -> api.PresenceCards
