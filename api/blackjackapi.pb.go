...
func (Mark) Descriptor() protoreflect.EnumDescriptor {
	return file_blackjackapi_proto_enumTypes[0].Descriptor()
}

func (Mark) Type() protoreflect.EnumType {
	return &file_blackjackapi_proto_enumTypes[0]
}
...
func (Mark) EnumDescriptor() ([]byte, []int) {
	return file_blackjackapi_proto_rawDescGZIP(), []int{0}
}
...
func (OpCode) Descriptor() protoreflect.EnumDescriptor {
	return file_blackjackapi_proto_enumTypes[1].Descriptor()
}

func (OpCode) Type() protoreflect.EnumType {
	return &file_blackjackapi_proto_enumTypes[1]
}
...
func (OpCode) EnumDescriptor() ([]byte, []int) {
	return file_blackjackapi_proto_rawDescGZIP(), []int{1}
}
...
func (x *Start) Reset() {
	*x = Start{}
	if protoimpl.UnsafeEnabled {
		mi := &file_blackjackapi_proto_msgTypes[0]
...
func (x *Update) Reset() {
	*x = Update{}
	if protoimpl.UnsafeEnabled {
		mi := &file_blackjackapi_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *Done) Reset() {
	*x = Done{}
	if protoimpl.UnsafeEnabled {
		mi := &file_blackjackapi_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Done) Descriptor() ([]byte, []int) {
	return file_blackjackapi_proto_rawDescGZIP(), []int{2}
}
...
func (x *Move) Reset() {
	*x = Move{}
	if protoimpl.UnsafeEnabled {
		mi := &file_blackjackapi_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Move) Descriptor() ([]byte, []int) {
	return file_blackjackapi_proto_rawDescGZIP(), []int{3}
}
...
func (x *RpcFindMatchRequest) Reset() {
	*x = RpcFindMatchRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_blackjackapi_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RpcFindMatchRequest) Descriptor() ([]byte, []int) {
	return file_blackjackapi_proto_rawDescGZIP(), []int{4}
}
...
func (x *RpcFindMatchResponse) Reset() {
	*x = RpcFindMatchResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_blackjackapi_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RpcFindMatchResponse) Descriptor() ([]byte, []int) {
	return file_blackjackapi_proto_rawDescGZIP(), []int{5}
}
...
var File_blackjackapi_proto protoreflect.FileDescriptor

var file_blackjackapi_proto_rawDesc = []byte{
	,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x09, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x4d, 0x61, 0x72, 0x6b, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38,
	0x01, 0x22, 0x64, 0x0a, 0x06, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x1f, 0x0a, 0x05, 0x62,
	0x6f, 0x61, 0x72, 0x64, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x09, 0x2e, 0x61, 0x70, 0x69,
	0x2e, 0x4d, 0x61, 0x72, 0x6b, 0x52, 0x05, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x12, 0x1d, 0x0a, 0x04,
	0x6d, 0x61, 0x72, 0x6b, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x09, 0x2e, 0x61, 0x70, 0x69,
	...
	,
...
var (
	file_blackjackapi_proto_rawDescOnce sync.Once
	file_blackjackapi_proto_rawDescData = file_blackjackapi_proto_rawDesc
)

func file_blackjackapi_proto_rawDescGZIP() []byte {
	file_blackjackapi_proto_rawDescOnce.Do(func() {
		file_blackjackapi_proto_rawDescData = protoimpl.X.CompressGZIP(file_blackjackapi_proto_rawDescData)
	})
	return file_blackjackapi_proto_rawDescData
}

var file_blackjackapi_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_blackjackapi_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_blackjackapi_proto_goTypes = []interface{}{
	(Mark)(0),                    // 0: api.Mark
...
var file_blackjackapi_proto_depIdxs = []int32{
...
func init() { file_blackjackapi_proto_init() }
func file_blackjackapi_proto_init() {
	if File_blackjackapi_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_blackjackapi_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Start); i {
			case 0:
				return &v.state
			case 1:
		...
		file_blackjackapi_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Update); i {
			case 0:
				return &v.state
			case 1:
		...
		file_blackjackapi_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Done); i {
			case 0:
				return &v.state
			case 1:
		...
		file_blackjackapi_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Move); i {
			case 0:
				return &v.state
			case 1:
		...
		file_blackjackapi_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_blackjackapi_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_blackjackapi_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_blackjackapi_proto_goTypes,
		DependencyIndexes: file_blackjackapi_proto_depIdxs,
		EnumInfos:         file_blackjackapi_proto_enumTypes,
		MessageInfos:      file_blackjackapi_proto_msgTypes,
	}.Build()
	File_blackjackapi_proto = out.File
	file_blackjackapi_proto_rawDesc = nil
	file_blackjackapi_proto_goTypes = nil
	file_blackjackapi_proto_depIdxs = nil
}
