...
func InitMapMockCodeListCard() {
	...
	// AkQJ10 bich 88887 354
	{
		cards := []*pb.Card{
			{Rank: pb.CardRank_RANK_4, Suit: pb.CardSuit_SUIT_SPADES}, {Rank: pb.CardRank_RANK_3, Suit: pb.CardSuit_SUIT_HEARTS}, {Rank: pb.CardRank_RANK_5, Suit: pb.CardSuit_SUIT_DIAMONDS},
	...
	// AkQJ10 bich 76543 nhép 654
	{
		cards := []*pb.Card{
			{Rank: pb.CardRank_RANK_6, Suit: pb.CardSuit_SUIT_SPADES}, {Rank: pb.CardRank_RANK_5, Suit: pb.CardSuit_SUIT_HEARTS}, {Rank: pb.CardRank_RANK_4, Suit: pb.CardSuit_SUIT_DIAMONDS},
